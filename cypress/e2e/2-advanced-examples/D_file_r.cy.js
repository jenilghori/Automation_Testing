...
// })
// it('Example for writeFile and readFile',()=>{

//     cy.visit('https://filesamples.com/formats/txt')
//     cy.get('[class="btn btn-primary pull-right"]').first().should('be.visible').click()


// })
// it('Verify the downloaded file', () => {
//     cy.readFile('cypress/downloads/sample3.txt')
//       .should('exist')
//   })
